...
export const DataProjects:project[]=[
    {
        ...
        ,'redux'],
        descripcionCorta:
        'ChatApp es una aplicación de mensajería en tiempo real que permite a todos los usuarios registrados en el sistema mantener conversaciones instantáneas entre ellos.',
